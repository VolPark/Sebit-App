                ...
                <table className="w-full text-left text-sm">
                    <thead className="bg-gray-50 dark:bg-slate-800 text-gray-600 dark:text-gray-400 border-b dark:border-slate-700">
                        <tr>
                            ...
                            <th className="p-4 text-right whitespace-nowrap">Rozpočet</th>
                            <th className="p-4 whitespace-nowrap">Stav</th>
                            <th className="p-4 text-right whitespace-nowrap">WIP</th>
                        </tr>
                    </thead>
                            ...
                            <tr key={p.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                                ...
                                <td className="p-4 text-right">
                                    <div className="flex flex-col items-end gap-1">
                                        <span className="font-mono text-slate-700 dark:text-slate-300">{p.budgetUsage.toFixed(0)}%</span>
                                ...
                                <td className="p-4">
                                    ...
                                    <div className="text-[10px] text-gray-400 mt-1">
                                        {p.totalActualHours}h / {p.totalEstimatedHours}h
                                    </div>
                                </td>
                    ...
                    <div key={p.id} className="bg-white dark:bg-slate-900 p-4 rounded-2xl shadow-sm ring-1 ring-slate-200/80 dark:ring-slate-700">
                        ...
                        <div className="mb-4">
                            <div className="flex justify-between text-sm mb-1">
                                <span className="text-slate-500">Čerpání rozpočtu</span>
                                <span className="font-bold text-slate-700 dark:text-slate-300">{p.budgetUsage.toFixed(0)}%</span>
                            </div>
