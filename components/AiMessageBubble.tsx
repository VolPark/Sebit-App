...
const CodeBlock = ({ node, inline, className, children, isLoading, ...props }: any) => {
    ...
    if (isTableRef && !inline) {
        try {
            ...
            return (
                <div className="my-1.5 group relative overflow-hidden rounded-lg border border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm transition-all hover:shadow-md hover:border-blue-200 dark:hover:border-blue-900">
                    <div className="absolute top-0 left-0 w-1 h-full bg-blue-500 dark:bg-blue-400"></div>
                    <div className="py-2 px-3 pl-4 flex items-start gap-3">
                        <div className="flex-shrink-0 mt-0.5">
                            <div className="w-7 h-7 rounded-md bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 flex items-center justify-center border border-blue-100 dark:border-blue-800">
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-0.5">
                                <h3 className="text-base font-bold text-gray-900 dark:text-gray-100 truncate font-mono tracking-tight">
                                    {data.name}
                                </h3>
                                <span className="text-[10px] uppercase tracking-wider font-bold text-blue-700 dark:text-blue-300 bg-blue-50 dark:bg-blue-900/30 px-1.5 py-px rounded border border-blue-100 dark:border-blue-800">
                                    Tabulka
                                </span>
                            </div>
    ...
    if (isAttributeRef && !inline) {
        try {
            const data = JSON.parse(content);
            return (
                <div className="my-1.5 group relative overflow-hidden rounded-lg border border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm transition-all hover:shadow-md hover:border-teal-200 dark:hover:border-teal-900">
                    <div className="absolute top-0 left-0 w-1 h-full bg-teal-500 dark:bg-teal-400"></div>
                    <div className="py-2 px-3 pl-4 flex items-start gap-3">
                        <div className="flex-shrink-0 mt-0.5">
                            <div className="w-7 h-7 rounded-md bg-teal-50 dark:bg-teal-900/20 text-teal-600 dark:text-teal-400 flex items-center justify-center border border-teal-100 dark:border-teal-800">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-0.5">
                                ...
                                <div className="flex items-center gap-1.5">
                                    <span className="text-[10px] uppercase tracking-wider font-bold text-teal-600 dark:text-teal-400 bg-teal-50 dark:bg-teal-900/30 px-1.5 py-px rounded border border-teal-100 dark:border-teal-800">
                                        Atribut
                                    </span>
                                    {data.table && (
                                        <span className="text-[10px] text-gray-400 dark:text-gray-500 flex items-center gap-0.5">
                                            v <span className="font-mono text-gray-500 dark:text-gray-400">{data.table}</span>
                                        </span>
                                    )}
                                </div>
                            </div>
