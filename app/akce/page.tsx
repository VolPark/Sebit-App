            ...
            {akce.map(a => (
              ...
              <div key={a.id} className={`bg-white rounded-lg p-4 shadow-sm ${a.is_completed ? 'opacity-60' : ''}`}>
                ...
                <div className="flex gap-2 mt-3">
                  ...
                  <button onClick={() => toggleCompleteAkce(a.id, a.is_completed)} className={`text-sm ${a.is_completed ? 'text-green-600' : 'text-gray-500'}`}>
                ...
                {akce.map(a => (
                  ...
                  <tr key={a.id} className={`hover:bg-gray-50 ${a.is_completed ? 'bg-gray-50 text-gray-400' : ''}`}>
                    ...
                    <td className="p-3 text-right">
                      ...
                      <button onClick={() => toggleCompleteAkce(a.id, a.is_completed)} className={`text-sm ${a.is_completed ? 'text-green-600' : 'text-gray-500'} mr-2`}>
